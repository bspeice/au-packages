...
$url        = 'https://sourceforge.net/projects/tuxguitar/files/TuxGuitar/TuxGuitar-1.5.3/tuxguitar-1.5.3-windows-x86-installer.exe/download' # download url, HTTPS preferred
...
$packageArgs = @{
  ...
  softwareName  = 'tuxguitar*' #part or all of the Display Name as you see it in Programs and Features. It should be enough to be unique
